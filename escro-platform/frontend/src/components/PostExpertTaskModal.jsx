...
export default function PostExpertTaskModal({ onClose, onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/experts/posted-tasks', {
        ...
        <div className="modal-content">
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '2rem', paddingBottom: '2rem', borderBottom: '1px solid #e0e0e0' }}>
              ...
              <div className="form-group">
                <label htmlFor="message">Message to Companies (Optional)</label>
                <textarea
                  id="message"
                  value={formData.message}
                  onChange={(e) => handleFieldChange('message', e.target.value)}
                  placeholder="Tell companies why they should work with you on this task. Share your expertise or specific requirements..."
                  rows="3"
                  maxLength="500"
                  className="message-textarea"
                />
