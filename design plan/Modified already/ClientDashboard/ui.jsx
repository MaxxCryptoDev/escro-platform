...
export function Icon({ name, size = 16, style, className, ...rest }) {
  ...
  switch (name) {
    ...
    case 'users': return <svg {...common}><circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0113 0"/><circle cx="17" cy="9" r="2.5"/><path d="M14 14.5a4.5 4.5 0 017.5 3.5"/></svg>;
    ...
    case 'star': return <svg {...common}><path d="M12 3l2.6 6 6.4.5-4.9 4.4 1.6 6.3L12 17l-5.7 3.2 1.6-6.3L3 9.5 9.4 9z"/></svg>;
...
// ——— Empty state ———
export function EmptyState({ icon = 'folder', title, description }) {
  return (
